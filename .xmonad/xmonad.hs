...
-- 3. Borders Configuration
myBorderWidth = 3
-- 4. Command buttom configuration
...
myLayout = onWorkspace (myWorkspaces !! 0) (avoidStruts (bigMonitor ||| tiledSpace ||| tiled ||| Mirror tiled) ||| fullTile)
	...
	where
		...
		tiledSpace  	= spacing 30 $ ResizableTall nmaster delta ratio [] 
...
--------------------------------------------------------------------------------------------------------------------
myWorkspaces = clickable $ ["1:main", "2:www",  "3:terminal", "4:dev", "5:Krita"]
...
myManageHook = composeAll 	[ resource =? "dmenu" --> doFloat
				...
				, resource =? "/usr/bin/google-chrome-stable"--> doShift (myWorkspaces !! 2)
				, resource =? "alacritty"--> doShift (myWorkspaces !! 3)
				, resource =? "vscode"--> doShift (myWorkspaces !! 4)
				, resource =? "krita"--> doShift (myWorkspaces !! 5)
				, manageDocks]
...
myLogHook h = dynamicLogWithPP ( defaultPP
	{
		...
		, ppLayout		= wrap "^ca(1,xdotool key alt+space)" "^ca()" . dzenColor color2 background .
				(\x -> case x of
					"Full"				->	"^i(/home/vladlazeb/.xmonad/dzen2/layout_full.xbm)"
					"Spacing 5 ResizableTall"	->	"^i(/home/vladlazeb/.xmonad/dzen2/layout_tall.xbm)"
					"ResizableTall"			->	"^i(/home/vladlazeb/.xmonad/dzen2/layout_tall.xbm)"
					"SimplestFloat"			->	"^i(/home/vladlazeb/.xmonad/dzen2/mouse_01.xbm)"
					"Circle"			->	"^i(/home/vladlazeb/.xmonad/dzen2/full.xbm)"
					_				->	"^i(/home/vladlazeb/.xmonad/dzen2/grid.xbm)"
				) 
...
myStatusBar = "/home/vladlazeb/.xmonad/status_bar '"++foreground++"' '"++background++"' "++myFont
--myConky = "conky -c /home/vladlazeb/conkyrc"
myStartMenu = "/home/vladlazeb/.xmonad/start /home/vladlazeb/.xmonad/start_apps"
...
--	xmproc 		<- spawnPipe "GTK2_RC_FILES=/home/vladlazeb/.gtkdocky /usr/bin/docky"
--	xmproc 		<- spawnPipe "tint2 -c /home/vladlazeb/.config/tint2/xmonad.tint2rc"
--	conky 		<- spawn myConky
...
--------------------------------------------------------------------------------------------------------------------
		`additionalKeys`
		[((mod1Mask .|. shiftMask	, xK_b), spawn "google-chrome-stable")
		,((mod1Mask  			, xK_b), spawn "krita")
		,((mod1Mask .|. shiftMask	, xK_n), spawn "alacritty")
		,((mod1Mask .|. shiftMask  	, xK_t), spawn "alacritty -e tmux")
		...
		,((mod1Mask 			, xK_r), spawn "/home/vladlazeb/scripts/lens")
		,((mod1Mask .|. shiftMask	, xK_r), spawn "/home/vladlazeb/scripts/dmenu/spotlight")
		...
		--,((0                     	, xF86XK_AudioLowerVolume), spawn "/home/vladlazeb/scripts/dvol2 -d 2 & mplayer /usr/share/sounds/freedesktop/stereo/audio-volume-change.oga")
		--,((0                     	, xF86XK_AudioRaiseVolume), spawn "/home/vladlazeb/scripts/dvol2 -i 2 & mplayer /usr/share/sounds/freedesktop/stereo/audio-volume-change.oga")
		,((0                     	, xF86XK_AudioMute), spawn "/home/vladlazeb/scripts/dvol2 -t")
		--,((0                     	, xF86XK_Display), spawn "/home/vladlazeb/scripts/project")
